...
const paths = [
  { title: 'index page', path: '/'},
  { title: 'Start page', path: '/ppc/start-page'},
  { title: 'Dob page', path: '/ppc/dob'},
  { title: 'Name page', path: '/ppc/name'},
  { title: 'Address page', path: '/ppc/postcode_v2'},
  { title: 'Select address page', path: '/ppc/address-lookup_v2'}
]
